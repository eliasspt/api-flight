...
<ul>
	...
	<li><strong>Gestión de Roles (RBAC):</strong> Roles de <code>admin</code> y <code>user</code> con permisos diferenciados.</li>
	<li><strong>Primer Registro Inteligente:</strong> El primer usuario registrado en la base de datos recibe automáticamente el rol de <code>admin</code>.</li>
	...
	<li><strong>Seguridad:</strong> Uso de <code>password_hash</code> con algoritmo BCRYPT y prevención de SQL Injection mediante consultas preparadas en PDO.</li>
</ul>
...
Clonar el repositorio:Bashgit clone https://github.com/tu-usuario/api-flight-usuarios.git
